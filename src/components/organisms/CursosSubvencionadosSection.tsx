            ...
            <div className="p-6">
              ...
              <div className="mb-6">
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                  <h5 className="font-medium text-blue-800 mb-2">Próximamente disponibles</h5>
                  <p className="text-sm text-blue-700 mb-2">
                    Estamos preparando una amplia oferta formativa específica para personas en búsqueda activa de empleo.
                  </p>
                  <p className="text-sm text-blue-700">
                    Inscríbete en nuestra lista de espera para recibir información prioritaria.
                  </p>
                </div>
              </div>
