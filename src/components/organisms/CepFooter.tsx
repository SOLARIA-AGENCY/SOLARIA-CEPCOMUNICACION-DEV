              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-pink-100">922 21 92 57</p>
                  </div>
                </div>
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-pink-100">info@cursostenerife.es</p>
                  </div>
                </div>
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-pink-100">Lunes a viernes 10 a 14hs. – 16 a 20hs.</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="text-center md:text-left mb-4 md:mb-0">
              <p className="text-gray-600">© 2025 CEP FORMACIÓN S.L.</p>
            </div>

            {/* Social Links */}
            <div className="flex items-center space-x-4 mb-4 md:mb-0">
              <a href="https://www.facebook.com/cepsantacruz/" className="text-gray-400 hover:text-cep-primary transition-colors">
                <Facebook className="w-5 h-5" />
              </a>
              <a href="https://www.instagram.com/cep_formacion/" className="text-gray-400 hover:text-cep-primary transition-colors">
                <Instagram className="w-5 h-5" />
              </a>
              <a href="#" className="text-gray-400 hover:text-cep-primary transition-colors">
