...
interface CursoDesempleadosPageComponentProps {
  curso: EmploymentCourseConfig;
}

const CursoDesempleadosPageComponent: React.FC<CursoDesempleadosPageComponentProps> = ({ curso }) => {
        ...
        <div className="relative container mx-auto px-4 py-12 sm:py-16">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <span className="inline-block bg-blue-500 text-white px-4 py-2 rounded-full text-sm font-medium mb-4">
              CURSO PARA TRABAJADORES DESEMPLEADOS
            </span>
      ...
      <div className="container mx-auto px-4 py-8 sm:py-12">
        <div className="max-w-6xl mx-auto">
          ...
          <section className="mb-12">
            <div className="bg-gradient-to-r from-blue-50 to-blue-100 rounded-xl p-6 sm:p-8">
                ...
                <div>
                  ...
                  <div className="space-y-2 text-gray-700">
                    ...
                    <p><strong>Email:</strong> 
                      <a href={`mailto:${curso.datos_especificos.contacto.email}`} className="text-blue-600 hover:underline ml-1">
                        {curso.datos_especificos.contacto.email}
                      </a>
                    </p>
                    <p><strong>Teléfono:</strong> 
                      <a href={`tel:${curso.datos_especificos.contacto.telefono}`} className="text-blue-600 hover:underline ml-1">
          ...
          {curso.objetivos && curso.objetivos.length > 0 && (
            <section className="mb-12">
              <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-6 text-center">
                <Award className="inline-block w-8 h-8 mr-3 text-blue-600" />
                Objetivos del Curso
              </h2>
          ...
          <section className="mb-12">
            <div className="bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-xl p-8 text-center">
              ...
              <button
                onClick={() => setIsModalOpen(true)}
                className="bg-white text-blue-600 px-8 py-4 rounded-lg font-bold text-lg hover:bg-gray-100 transition-colors transform hover:scale-105"
              >
...
export default CursoDesempleadosPageComponent;