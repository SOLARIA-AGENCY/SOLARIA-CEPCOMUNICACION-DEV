# 📊 MATRIZ DE CURSOS, SEDES Y FECHAS - CAMPAÑA OTOÑO 2025
...
**Periodo de campaña**: Junio - Octubre 2025  
**Inicio real**: 17 de junio 2025  
**Cliente**: CEP FORMACIÓN  
**Agencia**: SOLARIA.AGENCY  
**Plataformas**: Meta Business Suite (Facebook/Instagram Ads)  
**Infraestructura**: cepcomunicacion.com (dominio propio)  

### **CRONOGRAMA DE INTENSIDAD**
- **Junio-Julio 2025**: Pleno funcionamiento ✅
- **Agosto 2025**: Intensidad reducida
- **Septiembre-Octubre 2025**: Refuerzo completo

---

## 📋 MATRIZ COMPLETA DE CURSOS
...
| # | Curso | Fecha Inicio | Estado Campaña | Estado Técnico | Observaciones |
|---|-------|--------------|----------------|----------------|---------------|
| 1 | **Agente Funerario** | Septiembre 2025 | 🟡 PENDIENTE | 🔄 En desarrollo | **NUEVO** - Requiere video |
| 2 | **Auxiliar Clínico Veterinario** | Septiembre 2025 | 🟢 ACTIVA | ✅ Completo | Formulario operativo |
...
| Agente Funerario | CEP SANTA CRUZ | 🔄 Desarrollo |
| Auxiliar Clínico Veterinario | CEP NORTE | 🔄 Desarrollo |
...
| Curso | Sede | Estado |
|-------|------|--------|
| Auxiliar de Enfermería | CEP NORTE | ✅ Activa |
...
- Flujos n8n operativos
- Etiquetas Mailchimp configuradas

### **🔄 EN DESARROLLO (3 cursos nuevos)**
| Curso | Sede | Pendiente |
|-------|------|-----------|
| **Agente Funerario** | CEP SANTA CRUZ | Video creativo |
...
### **✅ VIDEOS PRODUCIDOS**
- **Adiestramiento Canino**: 2 formatos (1080x1080 + estándar)

### **🔄 VIDEOS PENDIENTES (PRIORIDAD ALTA)**
- **Agente Funerario** (CEP SANTA CRUZ)
- **Auxiliar Clínico Veterinario** (CEP NORTE)
- **Auxiliar Clínicas Estéticas** (CEP SANTA CRUZ)

### **ESPECIFICACIONES TÉCNICAS**
- **Duración**: 15 segundos
- **Formato**: Vertical (Reels) + Cuadrado
- **Estructura**:
...
## 🔄 FLUJO AUTOMATIZADO POR CURSO

### **PROCESO ESTÁNDAR**
1. **Lead completa formulario** → Meta Ads
2. **Sincronización automática** → Mailchimp (etiqueta específica)
3. **Email inmediato** → Plantilla personalizada por curso
4. **WhatsApp (15 min después)** → Confirmación interés
5. **Asignación asesor** → Google Sheets + email con guión
6. **Seguimiento automatizado** → Nurturing personalizado

### **CONFIGURACIÓN POR SEDE**
- **CEP NORTE**: Segmentación geográfica norte Tenerife
- **CEP SANTA CRUZ**: Segmentación Santa Cruz + sur Tenerife
...
### **KPIs POR CURSO**
- **Leads generados**: Por curso y sede
- **Tiempo de contacto**: <30 minutos objetivo
- **Tasa de contacto**: % leads contactados exitosamente
- **Conversión**: Lead → preinscripción → matrícula
- **ROI por curso**: Inversión vs ingresos generados

### **DASHBOARD EN TIEMPO REAL**
- **Google Sheets**: MASTER LEADS - OTOÑO 2025
- **n8n**: Logs de automatización y errores
- **Mailchimp**: Métricas de email marketing
- **Meta Ads**: Performance por conjunto de anuncios
...
1. 🎬 **Producir 3 videos pendientes** (Agente Funerario, ACV Norte, Clínicas Estéticas)
2. 📋 **Configurar formularios Meta Ads** para cursos nuevos
3. 📧 **Crear listas Mailchimp** para cursos nuevos
4. 🔗 **Vincular flujos n8n** para automatización completa

### **CORTO PLAZO (Próximas 2 semanas)**
1. 📊 **Implementar dashboard métricas** en tiempo real
2. 📞 **Capacitar asesores** con guiones por curso
3. 🎯 **Optimizar segmentación** geográfica por sede
4. 📈 **Configurar alertas** para monitoreo 24/7

---

## 📞 CONTACTOS Y RESPONSABILIDADES

**Gestión general**: SOLARIA.AGENCY  
**Desarrollo técnico**: Equipo n8n + Mailchimp  
**Creativos**: Departamento de video  
**Seguimiento**: Asesores CEP por sede  

### **COORDINACIÓN OPERATIVA**
- **Reuniones semanales**: Estado de implementación
- **Reportes diarios**: Métricas de leads y conversión
- **Escalado de urgencias**: Contacto directo SOLARIA

---

## 📋 CHANGELOG DE LA MATRIZ

**17 Junio 2025**: Creación de matriz actualizada  
- Incorporación de 3 cursos nuevos
- Actualización de estados técnicos
- Inclusión de cronograma acelerado
- Definición de acciones prioritarias

---

*Esta matriz es un documento vivo que se actualiza según el progreso de la campaña y los cambios en la estrategia.*

**#CEPFormacion #SolariaAgency #Otoño2025 #MatrizOperativa #MetaAds** 